...
def train(model = None, save_path = '', config={},  train_dataloader=None, val_dataloader=None, feature_map={}, test_dataloader=None, test_dataset=None, dataset_name='swat', train_dataset=None):
    ...
    for i_epoch in range(epoch):
        ...
        if val_dataloader is not None:
            ...
            # draw loss
            # if i_epoch == 0:
            #     viz.line([[acu_loss/len(dataloader), val_loss, acu_loss]], [0.], win="loss", opts = dict(title = 'loss',legend = ['train_loss','val_loss','acu_loss']))
            # viz.line([[acu_loss/len(dataloader), val_loss, acu_loss]], [i_epoch], win="loss", update='append')
